...
public class Polygon extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener {
    ...
    private com.baidu.mapapi.map.Polygon mPolygon;
    private com.baidu.mapapi.map.Polygon mPolygonTwo;
    ...
    public void initPolygon(){
        ...
        // 添加覆盖物
        mPolygon = (com.baidu.mapapi.map.Polygon) mBaiduMap.addOverlay(ooPolygon);
        ...
        // 添加覆盖物
        mPolygonTwo = (com.baidu.mapapi.map.Polygon) mBaiduMap.addOverlay(overlayOptions);
