...
public class Arc extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener {
    ...
    private com.baidu.mapapi.map.Arc mArcOne;
    private com.baidu.mapapi.map.Arc mArcTwo;
    ...
    public void initArc() {
        ...
        mArcOne = (com.baidu.mapapi.map.Arc) mBaiduMap.addOverlay(overlayOptionsA);
        ...
        mArcTwo = (com.baidu.mapapi.map.Arc) mBaiduMap.addOverlay(overlayOptionsB);
