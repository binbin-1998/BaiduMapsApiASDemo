...
public class Circle extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener {
    ...
    // 绘制圆
    private com.baidu.mapapi.map.Circle mCircle;
    private com.baidu.mapapi.map.Circle mCircleTwo;
    ...
    public void initCircle() {
        ...
        mCircle = (com.baidu.mapapi.map.Circle) mBaiduMap.addOverlay(ooCircleA);
        ...
        mCircleTwo = (com.baidu.mapapi.map.Circle) mBaiduMap.addOverlay(ooCircleB);
    }
