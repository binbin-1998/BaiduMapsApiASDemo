...
public class Polyline extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener {

    // 地图相关
    private MapView mMapView;
    private BaiduMap mBaiduMap;
    // 普通折线，点击时改变宽度
    private com.baidu.mapapi.map.Polyline mPolyline;
    // 多颜色折线，点击时消失
    private com.baidu.mapapi.map.Polyline mColorfulPolyline;
    // 纹理折线，点击时获取折线上点数及width
    private com.baidu.mapapi.map.Polyline mTexturePolyline;
    ...
    private void initPolyline() {
        ...
        // 添加覆盖物
        mPolyline = (com.baidu.mapapi.map.Polyline) mBaiduMap.addOverlay(ooPolyline);
        ...
        // 添加覆盖物
        mColorfulPolyline = (com.baidu.mapapi.map.Polyline) mBaiduMap.addOverlay(ooPolylineA);
        ...
        // 添加覆盖物
        mTexturePolyline = (com.baidu.mapapi.map.Polyline) mBaiduMap.addOverlay(ooPolylineAA);
    }
