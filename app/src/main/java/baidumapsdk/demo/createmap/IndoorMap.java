...
public class IndoorMap extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        double latitude=intent.getDoubleExtra("latitude",39.916958);
        double longitude=intent.getDoubleExtra("longitude",116.379278);
        ...
        // 楼层条数据适配器
        mFloorListAdapter = new BaseStripAdapter(IndoorMap.this);
