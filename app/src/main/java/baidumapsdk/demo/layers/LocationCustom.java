 ...
 * 展示定位图层自定义样式
 */
public class LocationCustom extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mBaiduMap.setOnMyLocationClickListener(new BaiduMap.OnMyLocationClickListener() {
            ...
            public boolean onMyLocationClick() {
                Toast.makeText(LocationCustom.this,"点击定位图标", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
        mBaiduMap.setOnMarkerClickListener(new BaiduMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                Toast.makeText(LocationCustom.this,"点击Marker图标", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
