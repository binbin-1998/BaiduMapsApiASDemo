...
public class IndoorRoute extends AppCompatActivity implements OnGetRoutePlanResultListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mIndoorRoutePlaneBtn.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(IndoorRoute.this,"请输入正确经纬度",Toast.LENGTH_LONG).show();
                    return;
                }

                if (startfloor.isEmpty() || endfloor.isEmpty()){
                    Toast.makeText(IndoorRoute.this,"请输楼层信息",Toast.LENGTH_LONG).show();
                    return;
                }
        ...
        mFloorListAdapter = new BaseStripAdapter(IndoorRoute.this);
